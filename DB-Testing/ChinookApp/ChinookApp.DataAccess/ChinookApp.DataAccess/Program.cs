...
namespace ChinookApp.DataAccess
{
    class Program
    {
        ...
        public static void UpdateSomeData()
        {
            ...
            var course = context.Course.Find(1000); //primary key 1000
        ...
        public static void AddSomeDataFromUserInput()
        {
            ...
            Artist artist = context.Artist.FirstOrDefault(a => a.Name == name);
            
            Artist art = new Artist{Name = name};
            context.Album
                .Add(new Album{Artist = art});
        ...
        public static void DisplayData()
        {
            ...
            List<Album> albums = context.Album
                .Include(s => s.Artist)
                .Where(a => a.ArtistId > 265)
                .ToList();
            ...
            foreach (var alb in albums)
            {
                ...
                //var coursesString = string.Join(", ", courses); // // //  Tracks: {string.Join(", ",alb.Track.ToList())}
                Console.WriteLine($"[{alb.ArtistId}] {alb.Artist.Name}:");
            }
        }
    }
}
